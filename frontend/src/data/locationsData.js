...
// NEW: Data for the Circle (Zone) dropdown
...
  { value: 'North-East-Zone', label: 'North-East Zone' },
];

// Your original state and district data remains the source of truth
...
      "East Siang", "Siang", "Upper Siang", "Anjaw", "Lower Dibang Valley",
...
      "Kalaburagi", "Hassan", "Haveri", "Kodagu", "Kolar", "Koppal",
...
// This helper function formats the data into the grouped structure 
// required for the Node/Location dropdown.
export const groupedLocationsData = statesData.map(state => ({
    label: state.state, // Group header (e.g., "Tamil Nadu")
    options: state.districts.map(district => ({
        value: district,
        label: district // Selectable option (e.g., "Chennai")
    }))
}));